...
<head>
    ...
    <title>NeuroradRCE</title>
    <link rel="icon" href="{{ asset('assets/img/1.png') }}" type="image/icon type">
...
<nav class="navbar navbar-light navbar-expand-md fixed-top" style="background-color:#292c2f;">
    <div class="container-fluid"><a class="navbar-brand" href="{{ url('/') }}" style="color: #e9711c;font-family: 'Alike Angular', serif;font-size: 24px;">
            ...
            <strong>Neurorad RCE</strong></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
...
<div id="promo">
    <section>
        <div class="bg-light border rounded border-light jumbotron">
            <h1 class="text-center" style="font-size: 28px;color: rgb(255,255,255);">Welcome to Neurorad RCE!</h1>
            <p class="text-center" style="font-size: 16px;color: rgb(255,255,255);">This is the site of clinical registry with the highest security standards. The anonymity of the information is ensured for the sole purpose of improving health care.</p>
            <p class="text-center">
                @if (Route::has('login'))
                    @auth
...
<div class="container site-section" id="welcome">
    <h1 style="color: rgb(255,255,255);font-size: 28px;">A powerful and elegant healthcare tool</h1>
    <p style="color: rgb(255,255,255);font-size: 16px;text-align: justify">The idea under the roof is to be able to have a powerful tool to keep your healthcare cases safe and private, and to be able to give the best care to patientes when needed. It may be a clinical meeting, or a schedule for a surgery, or a presentation in a committee, or perhaps you want to remember in which part of the process you are. The level of privacy is the highest. Welcome!</p>
</div>
    ...
    <div class="container" id="foot">
        <div class="row">
            <div class="col-sm-6 col-md-4 footer-navigation">
                <h3>NeuroradRCE</h3>
                <p class="links"><a href="#" style="font-size: 14px;">Register</a><strong> · </strong><a href="#welcome" style="font-size: 14px;">Plan</a><strong> · </strong><a href="#learn" style="font-size: 14px;">Improve</a><strong>&nbsp;</strong></p>
                <p class="company-name">NeuroradRCE by Neurorad Co. © 2022</p>
            </div>
