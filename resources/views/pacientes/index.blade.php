...
{{--                        <i class="{{ $paciente -> scheduled == 0 ? 'fas fa-times': 'fas fa-check-circle' }}"></i>--}}
    ...
    {{--                        <a href="{{ route('paciente.edit', [$paciente->id, 'origen'=>'index']) }}" class="btn btn-sm btn-primary">Editar</a>--}}
                            <a href="{{ route('paciente.edit', [$paciente->id, 'origen'=>'index']) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar"><i class="fa fa-lg fa-fw fa-pen"></i></a>
    {{--                    </td>--}}
    {{--                    <td>--}}
