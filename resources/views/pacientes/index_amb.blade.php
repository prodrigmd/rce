...
{{--                            {{ \Carbon\Carbon::parse($paciente -> action_next_date)->format('d-m-Y') }}--}}
    ...
    {{--                        <a href="{{ route('paciente.edit', [$paciente->id, 'origen'=>'index']) }}" class="btn btn-sm btn-primary">Editar</a>--}}
                            <a href="{{ route('paciente.edit', [$paciente->id, 'origen'=>'index_amb']) }}" class="btn btn-xs btn-default text-primary mx-1 shadow" title="Editar"><i class="fa fa-lg fa-fw fa-pen"></i></a>
    {{--                    </td>--}}
    {{--                    <td>--}}
