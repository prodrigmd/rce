...
//            ->orderBy('documents_type.name')
    ...
    public function update(Request $request, Document $document)
    {
        $validatedData = $request -> validate([
            ...
            'diagnosis' => 'nullable',
            'history' => 'nullable',
            'surgeriesList' => 'nullable',
            'surgeriesDetail' => 'nullable',
            'surgeriesPosition' => 'nullable',
            'supplies' => 'nullable',
            'equipment' => 'nullable',
            'consignaciones' => 'nullable',
            'bloodProducts' => 'nullable',
            'diasHosp' => 'nullable',
            'email' => 'nullable',
            'Interconsulta' => 'nullable',
            'paseMatronaYN' => 'nullable',
            'thromboticRiskBMA' => 'nullable',
            'ambulatorioYN' => 'nullable',
            'description' => 'nullable',
...
//        dd($validatedData['patientName']);
        ...
        $values = array(
            ...
            'surgeriesList' => $validatedData['surgeriesList'] ?? null,
            'surgeriesDetail' => $validatedData['surgeriesDetail'] ?? null,
            'surgeriesPosition' => $validatedData['surgeriesPosition'] ?? null,
            'supplies' => $validatedData['supplies'] ?? null,
            'equipment' => $validatedData['equipment'] ?? null,
            'consignaciones' => $validatedData['consignaciones'] ?? null,
            'bloodProducts' => $validatedData['bloodProducts'] ?? null,
            'diasHosp' => $validatedData['diasHosp'] ?? null,
            'email' => $validatedData['email'] ?? null,
            'Interconsulta' => $validatedData['Interconsulta'] ?? null,
            'paseMatronaYN' => $validatedData['paseMatronaYN'] ?? null,
            'thromboticRiskBMA' => $validatedData['thromboticRiskBMA'] ?? null,
            'ambulatorioYN' => $validatedData['ambulatorioYN'] ?? null,
