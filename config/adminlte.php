...
return [
    ...
    */
    ...
    'logo' => 'Neurorad<b>RCE</b>',
    'logo_img' => 'vendor/adminlte/dist/img/apple-icon-144x144.png',
    ...
    */
    ...
    'right_sidebar' => true,
    'right_sidebar_icon' => 'fas fa-chalkboard',
...
//            'url'  => 'admin/settings',
        ...
        [
            'text' => 'Hospitalizados',
            'route'  => 'paciente_hosp.index',
//            'icon' => 'fas fa-circle',
        ],
        [
            'text' => 'Ambulatorios',
            'route'  => 'paciente_amb.index',
//            'icon' => 'far fa-circle',
        ],
        [
            'text' => 'Alta',
            'route'  => 'paciente_alta.index',
//            'icon' => 'far fa-square',
        ],
        [
...
//            'url'  => 'admin/settings',
        ...
        [
            'text' => 'Todos los protocolos',
            'route'  => 'protocol.index',
//            'url'  => 'admin/settings',
            'icon' => 'fas fa-book-medical',
        ],
        [
            'header' => 'Gestor de Documentos',
            'classes'  => 'bg-gradient-dark',
        ],
        [
            'text' => 'Documentos',
...
//            'icon' => 'fas fa-file-prescription',
        ...
        [
            'text' => 'Subtipos de documentos',
            'route'  => 'document_type_subtypes.index',
//            'icon' => 'fas fa-file-prescription',
        ],
        [
...
//            'url'  => 'admin/settings',
        ...
        [
            'text'    => 'Roles y Permissions',
            'icon'    => 'fas fa-hat-wizard',
            'can'  => 'admin',
            'submenu' => [
                [
                    'text' => 'Roles per user',
                    'route'  => 'rolesUsers.index',
//                    'url'  => 'admin/settings',
                    'can'  => 'admin',
